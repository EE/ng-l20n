/**
 * @license AngularJS v1.1.6-aa7ed52
 ...
 */
var version = {
  full: '1.1.6-aa7ed52',    // all of these placeholder strings will be replaced by grunt's
...
LocationHashbangInHtml5Url.prototype =
  ...
  /**
   * @ngdoc method
   * @name ng.$location#replaceState. Changes url, state and title.
   * @methodOf ng.$location
   *
   * @description
